...
> Copia locale per il tracker; la versione di riferimento vive anche in [`docs/prd/redis-pubsub-diary-events.md`](../../docs/prd/redis-pubsub-diary-events.md). Piano operativo file-by-file in [`PIANO_REDIS_PUBSUB_DIARIO.md`](../../PIANO_REDIS_PUBSUB_DIARIO.md).

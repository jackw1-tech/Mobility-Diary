...
void main() {
  group('HarSensorWindow', () {
    test('normalizes raw samples to the 500 x 9 model shape', () {
      ...
      expect(modelInput.first, hasLength(9));
      expect(modelInput.first, List<double>.filled(9, 0));
      expect(modelInput.last, List<double>.filled(9, 10));
    });
  });
}

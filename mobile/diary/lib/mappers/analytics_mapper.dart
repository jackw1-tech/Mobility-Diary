...
class AnalyticsMapper {
  Analytics mapAnalytics(AnalyticsDto dto) => Analytics(
    ...
    frequentRoutes: dto.frequentRoutes.map(mapRoute).toList(growable: false),
    weeklyHeatmaps: dto.weeklyHeatmaps
        .map(mapWeeklyHeatmap)

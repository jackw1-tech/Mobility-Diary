...
try:
    ...
    cnn = tf.keras.models.load_model('../models_5class/shl_cnn1d_full_100pct_5class_best.keras', compile=False)
    from tensorflow.keras.models import Model
    # La GRU ha bisogno degli embedding (layer -3 della CNN)
    extractor = Model(cnn.inputs, cnn.layers[-3].output)
    
    gru = tf.keras.models.load_model('../models_gru/shl_6ch_5class_gru_best.keras', compile=False)
